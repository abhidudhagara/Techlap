...
$title_array = array(
    ...
    "cart.php" => "Cart",
    "shop.php" => "Shop",
    "login.php" => "Log in to Techlap",
    "register.php" => "Register to Techlap",
    "wishlist.php" => "Your Favourites",
    "about.php" => "About Techlap",
        ...
        <nav id="navibar" class="navbar navbar-expand-lg navbar-light sticky-top container-fluid">
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
                        <a class="logo navbar-brand fs-1 fw-bold" href="index.php">Techlap</a>
                    <ul class="links navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item">
                            <a class="nav-link <?php echo $title == "About Techlap" ? "active" : "" ?>" href="about.php">About</a>
                        </li>
                    </ul>
